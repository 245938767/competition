...
(function ($) {
    $.extend({
        ...
        operate: {
            ...
            restorSort: function (id) {

                table.set();
                $.modal.confirm("确定开始创建" + table.options.modalName + "的比赛名单吗？", function () {
                    var url = $.common.isEmpty(id) ? table.options.restorySortUrl : table.options.restorySortUrl.replace("{id}", id);
                    $.operate.post(url);
                });
            },
            ...
            restoreData: function (id) {
                ...
                $.modal.confirm("确定要重置比赛数据吗？", function () {

                    var url = $.common.isEmpty(id) ? table.options.cleanCompetitionUrl : table.options.cleanCompetitionUrl.replace("{id}", id);
                    $.operate.submit(url, "post", "json", "");
                });
